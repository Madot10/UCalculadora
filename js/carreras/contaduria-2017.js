var contaduria = [
    ...
    { Semestre: "TERCER SEMESTRE", Asignatura: "Investigación Aplicada", UC: 4, Tax: "TA‐8" },
    ...
    { Semestre: "QUINTO SEMESTRE", Asignatura: "Auditoria y Aseguramiento I", UC: 5, Tax: "TA‐1" },
    ...
    { Semestre: "SEXTO SEMESTRE", Asignatura: "Auditoría y Aseguramiento II", UC: 5, Tax: "TA‐1" },
    {
        Semestre: "SEXTO SEMESTRE",
    ...
    { Semestre: "OCTAVO SEMESTRE", Asignatura: "Control de Gestión", UC: 4, Tax: "TA‐3" },
    {
        ...
        Asignatura: "Emprendimiento (Virtual)",
        UC: 4,
        Tax: "(SP) TA‐1",
    },
    ...
    { Semestre: "OCTAVO SEMESTRE", Asignatura: "Auditoría y Aseguramiento IV", UC: 5, Tax: "TA‐1" },
    ...
    { Semestre: "[A]SEXTO SEMESTRE", Asignatura: "Contabilidad Superior II", UC: 5, Tax: "TA‐1" },
    { Semestre: "[A]SEXTO SEMESTRE", Asignatura: "Derecho Laboral", UC: 6, Tax: "TA‐1" },
    { Semestre: "[A]SEXTO SEMESTRE", Asignatura: "Mercados Financieros", UC: 4, Tax: "TA‐1" },
    { Semestre: "[A]SEXTO SEMESTRE", Asignatura: "Matemáticas Financieras II", UC: 5, Tax: "TA‐1" },
    {
        Semestre: "[A]SEXTO SEMESTRE",
        Asignatura: "Contabilidad de Inst. Financieras",
        UC: 6,
        Tax: "TA‐1",
    },
    { Semestre: "[A]SEXTO SEMESTRE", Asignatura: "Contabilidad de Seguros", UC: 6, Tax: "TA‐1" },
    {
        Semestre: "[A]SÉPTIMO SEMESTRE",
        Asignatura: "Administración Financiera I",
        UC: 6,
        Tax: "TA‐1",
    },
    { Semestre: "[A]SÉPTIMO SEMESTRE", Asignatura: "Derecho Fiscal I", UC: 3, Tax: "TA‐1" },
    {
        Semestre: "[A]SÉPTIMO SEMESTRE",
    ...
    { Semestre: "[A]SÉPTIMO SEMESTRE", Asignatura: "Auditoría I", UC: 3, Tax: "TA‐1" },
    { Semestre: "[A]SÉPTIMO SEMESTRE", Asignatura: "Contabilidad Avanzada I", UC: 3, Tax: "TA‐1" },
    {
    ...
    { Semestre: "[A]OCTAVO SEMESTRE", Asignatura: "Derecho Fiscal II", UC: 3, Tax: "TA‐1" },
    { Semestre: "[A]OCTAVO SEMESTRE", Asignatura: "Contabilidad de Costos II", UC: 6, Tax: "TA‐1" },
    { Semestre: "[A]OCTAVO SEMESTRE", Asignatura: "Auditoría II", UC: 3, Tax: "TA‐1" },
    { Semestre: "[A]OCTAVO SEMESTRE", Asignatura: "Contabilidad Avanzada II", UC: 3, Tax: "TA‐1" },
    {
        Semestre: "[A]OCTAVO SEMESTRE",
        Asignatura: "Tributación Estadal y Municipal",
        UC: 3,
        Tax: "TA‐1",
    },
    { Semestre: "[A]NOVENO SEMESTRE", Asignatura: "Derecho Tributario I", UC: 6, Tax: "TA‐1" },
    { Semestre: "[A]NOVENO SEMESTRE", Asignatura: "Presupuesto Empresarial I", UC: 6, Tax: "TA‐1" },
    {
        Semestre: "[A]NOVENO SEMESTRE",
        Asignatura: "Análisis de Estados Financieros I",
        UC: 4,
        Tax: "TA‐1",
    },
    {
        Semestre: "[A]NOVENO SEMESTRE",
        Asignatura: "Sistema de Información General",
        UC: 2,
        Tax: "TA‐1",
    },
    { Semestre: "[A]NOVENO SEMESTRE", Asignatura: "Auditoría III", UC: 3, Tax: "TA‐1" },
    {
        Semestre: "[A]NOVENO SEMESTRE",
    ...
    { Semestre: "[A]NOVENO SEMESTRE", Asignatura: "Seminario I", UC: 2, Tax: "TA‐1" },
    { Semestre: "[A]DÉCIMO SEMESTRE", Asignatura: "Derecho Tributario II", UC: 6, Tax: "TA‐1" },
    {
        Semestre: "[A]DÉCIMO SEMESTRE",
        Asignatura: "Presupuesto Empresarial II",
        UC: 6,
        Tax: "TA‐1",
    },
    {
    ...
    { Semestre: "[A]DÉCIMO SEMESTRE", Asignatura: "Contabilidad de Costos IV", UC: 4, Tax: "TA‐1" },
    { Semestre: "[A]DÉCIMO SEMESTRE", Asignatura: "Auditoría IV", UC: 3, Tax: "TA‐1" },
    { Semestre: "[A]DÉCIMO SEMESTRE", Asignatura: "Auditoría de Sistemas", UC: 2, Tax: "TA‐1" },
    { Semestre: "[A]DÉCIMO SEMESTRE", Asignatura: "Ética Profesional", UC: 3, Tax: "TA‐1" },
    { Semestre: "[A]DÉCIMO SEMESTRE", Asignatura: "Seminario II", UC: 2, Tax: "TA‐1" },
];
