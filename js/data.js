...
let tables = {
    ...
    2019192: [
        ...
        [
            'Julio (25%) <i class="fas fa-question-circle" onclick="modalInfoOpen(genMsgUc(`7/1/19`))"></i>',
            'eval("formatNumber.new((Number(GetMontoTarifa(`07/01/2019`)) * 0.25), `Bs.S `, true)")',
        ],
    ],
    219: [
        3,
    ...
    2019202: [
        ...
        [
            "Diciembre (25%)",
            '<span class="ugreen">Total (+DI)*: <i class="fas fa-question-circle" onclick="modalInfoOpen(genMsgUc(`11/1/19`))"></i> </span></span>  <br> eval("formatNumber.new((GetMontoTarifa(`11/1/19`) * 0.25) + (0.25 * valorUC), `Bs.S `,true)")',
        ],
        [
            "Enero (25%)",
